...
for i = 1:NN
    ...
    [papr(i),BER(i),SER(i)] = get_measure(Best,Pt1,Pt2,Pt3,Pt4,Pt);
    [papr2(i),BER2(i),SER2(i)] = get_measure(Bestbee,Pt1,Pt2,Pt3,Pt4,Pt);
    [papr1(i),BER1(i),SER1(i)] = get_measure(Bestnest,Pt1,Pt2,Pt3,Pt4,Pt);
...
% Papr vs number of iterations for PTS,CS,ABC,AbCCS
% BER Vs SNR
% SER Vs SNR
